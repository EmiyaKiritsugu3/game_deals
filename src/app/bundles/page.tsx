                                ...
                                <div className={styles.bundleFooter}>
                                    <div className={styles.bundlePricing}>
                                        ...
                                        <span className={styles.bundleValue}>
                                            {bundle.games.length} games · Value <strong>${bundle.totalValue.toFixed(2)}</strong>
                                        </span>
                                    </div>

                                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end' }}>
                                        <a href={bundle.url} target="_blank" rel="noopener noreferrer" className={styles.bundleCta}>
                                            -{savings}% · Get Bundle →
                                        </a>
