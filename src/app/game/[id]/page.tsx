            ...
            <div className={styles.statsRow}>
              ...
              <div className={styles.statBlock}>
                ...
                <span className={styles.statSub}>
                  {new Date(game.cheapestPriceEver.date * 1000).toLocaleDateString('en-US', {
                    month: 'short',
                    year: 'numeric',
                  })}
                </span>
        ...
        <div className={styles.storeComparison}>
          {(() => {
            ...
            const bestOfficialPrice =
              officialDeals.length > 0 ? parseFloat(officialDeals[0].price) : null;
            const bestKeyshopPrice =
              keyshopDeals.length > 0 ? parseFloat(keyshopDeals[0].price) : null;
                ...
                >
                  ...
                  <div className={styles.dealPriceInfo}>
                    ...
                    <div className={styles.prices}>
                      {savings > 0 && !isFree && (
                        <span className={styles.retail}>${deal.retailPrice}</span>
                      )}
                      {isFree ? (
                  ...
                  <>
                    ...
                    <div className={styles.dealsList}>
                      {officialDeals.map((deal) =>
                        renderDealRow(
                          deal,
                          parseFloat(deal.price) === bestOfficialPrice,
                          cheapestEver
                        )
                      )}
                    </div>
                  ...
                  <>
                    ...
                    <div className={styles.dealsList}>
                      {keyshopDeals.map((deal) =>
                        renderDealRow(
                          deal,
                          parseFloat(deal.price) === bestKeyshopPrice,
                          cheapestEver
                        )
                      )}
                    </div>
