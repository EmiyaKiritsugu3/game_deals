...
import { getDeals, getStores, type Store } from '@/services/api';
...
export default async function SearchPage({
  ...
  const [_storesMap, storesResponse] = await Promise.all([
    getStores(),
    fetch('https://www.cheapshark.com/api/1.0/stores').then((res) => res.json()) as Promise<
      Store[]
    >,
  ]);
