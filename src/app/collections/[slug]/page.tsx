...
function gameDataToDeal(gameData: GameDetails, gameID: string): DealWithStore {
  // ⚡ Bolt: Replaced O(N log N) sorting and O(N) array allocation with a single-pass O(N) iteration.
  // Reduces unnecessary CPU overhead and garbage collection during server-side map operations over batch results.
