...
function gameDataToDeal(gameData: GameDetails, gameID: string): DealWithStore {
  // ⚡ Bolt Performance: Use O(N) linear search to find cheapest deal instead of O(N log N) sort
  // Prevents unnecessary array allocation and sorting overhead during server-side batch mapping.
