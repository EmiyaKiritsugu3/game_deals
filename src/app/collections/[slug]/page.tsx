...
function gameDataToDeal(gameData: GameDetails, gameID: string): DealWithStore {
  // ⚡ Bolt Performance: Prevent O(N log N) sorting and O(N) memory allocation to find minimum price.
  // Using getCheapestDeal provides an O(N) iteration, saving CPU time in server-side batch mapping loops.
