...
function gameDataToDeal(gameData: GameDetails, gameID: string): DealWithStore {
  // ⚡ Bolt Performance: Use O(N) getCheapestDeal instead of O(N log N) sorting
  // Prevents unnecessary array allocation and sorting during server-side batch mapping
