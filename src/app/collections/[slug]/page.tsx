...
function gameDataToDeal(gameData: GameDetails, gameID: string): DealWithStore {
  // ⚡ Bolt: Use O(N) getCheapestDeal instead of [...gameData.deals].sort(...)[0]
  // Impact: Eliminates O(N log N) time complexity and O(N) memory allocation per game in the batch.
