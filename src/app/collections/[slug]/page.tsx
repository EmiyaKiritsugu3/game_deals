...
function gameDataToDeal(gameData: GameDetails, gameID: string): DealWithStore {
  // ⚡ Bolt Performance: Use O(N) getCheapestDeal instead of O(N log N) sorting and O(N) array allocation.
  // This is critical in SSG loops to prevent cumulative garbage collection overhead.
