...
function gameDataToDeal(gameData: GameDetails, gameID: string): DealWithStore {
  // ⚡ Bolt Performance: Prevent O(N log N) sorting and O(N) array allocation on every deal mapping
  // by using the O(N) getCheapestDeal utility instead of [...gameData.deals].sort()[0]
