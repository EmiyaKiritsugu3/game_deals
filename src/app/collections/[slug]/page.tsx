...
function gameDataToDeal(gameData: GameDetails, gameID: string): DealWithStore {
  // ⚡ Bolt Performance: Using getCheapestDeal instead of sorting prevents O(N log N) time complexity
  // and unnecessary O(N) memory allocation inside this reduction loop.
