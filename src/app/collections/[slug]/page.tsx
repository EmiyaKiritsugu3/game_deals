...
function gameDataToDeal(gameData: GameDetails, gameID: string): DealWithStore {
  // ⚡ Bolt Performance: Prevent O(N log N) sorting and O(N) array allocation overhead per game
  // by using a single-pass O(N) min-search. This saves CPU time when mapping large collections.
