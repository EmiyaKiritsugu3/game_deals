...
export const BUNDLES: Bundle[] = [
  {
    ...
    games: [
      ...
      },
      {
        title: 'Outer Wilds',
        retailPrice: 24.99,
        thumb: 'https://cdn.cloudflare.steamstatic.com/steam/apps/753640/header.jpg',
      },
      {
        title: 'Hades',
        retailPrice: 24.99,
      ...
      },
      {
        title: 'Inscryption',
        retailPrice: 19.99,
        thumb: 'https://cdn.cloudflare.steamstatic.com/steam/apps/1092790/header.jpg',
      },
      {
        title: 'Disco Elysium',
        retailPrice: 34.99,
  ...
  },
  {
    ...
    games: [
      ...
      },
      {
        title: 'Ghostrunner',
        retailPrice: 29.99,
        thumb: 'https://cdn.cloudflare.steamstatic.com/steam/apps/1139900/header.jpg',
      },
      {
        title: 'Katana ZERO',
        retailPrice: 14.99,
        thumb: 'https://cdn.cloudflare.steamstatic.com/steam/apps/460950/header.jpg',
      },
      {
        title: 'Hollow Knight',
        retailPrice: 14.99,
      ...
      },
      {
        title: 'Cuphead',
        retailPrice: 19.99,
        thumb: 'https://cdn.cloudflare.steamstatic.com/steam/apps/268910/header.jpg',
      },
    ],
  },
  {
    ...
    games: [
      ...
      },
      {
        title: 'Terraria',
        retailPrice: 9.99,
        thumb: 'https://cdn.cloudflare.steamstatic.com/steam/apps/105600/header.jpg',
      },
      {
        title: 'Dead Cells',
        retailPrice: 24.99,
        thumb: 'https://cdn.cloudflare.steamstatic.com/steam/apps/588650/header.jpg',
      },
      {
        title: 'Ori and the Blind Forest',
        retailPrice: 19.99,
        thumb: 'https://cdn.cloudflare.steamstatic.com/steam/apps/261570/header.jpg',
      },
      {
        title: 'Risk of Rain 2',
        retailPrice: 24.99,
        thumb: 'https://cdn.cloudflare.steamstatic.com/steam/apps/632360/header.jpg',
      },
      {
        title: 'Subnautica',
        retailPrice: 29.99,
        thumb: 'https://cdn.cloudflare.steamstatic.com/steam/apps/264710/header.jpg',
      },
      {
        title: 'Undertale',
        retailPrice: 9.99,
        thumb: 'https://cdn.cloudflare.steamstatic.com/steam/apps/391540/header.jpg',
      },
      {
        title: 'Rimworld',
        retailPrice: 34.99,
