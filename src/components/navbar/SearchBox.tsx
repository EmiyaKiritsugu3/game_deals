  ...
  return (
    <div className="w-full max-w-[480px] relative" ref={dropdownRef}>
      ...
      <form action="/search" className="flex relative items-center" role="search">
        ...
        <button
          type="submit"
          className="absolute left-3 text-muted-foreground flex items-center justify-center peer-focus:text-primary rounded-sm focus-visible:outline-2 focus-visible:outline-primary focus-visible:outline-offset-2"
