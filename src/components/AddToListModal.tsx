    ...
    <>
      ...
      <div className="flex flex-col gap-3 mb-6">
        <input
          ...
          className="bg-black/30 border border-border rounded-lg p-3 text-foreground text-[0.95rem] placeholder:text-muted-foreground"
        />
        <button
          type="button"
  ...
  return (
    ...
    >
      ...
      >
        ...
        <button
          type="button"
          className="bg-none border-none text-muted-foreground w-full p-2 cursor-pointer focus-visible:outline-2 focus-visible:outline-primary focus-visible:outline-offset-2"
          onClick={onClose}
        >
          Cancel
        </button>
