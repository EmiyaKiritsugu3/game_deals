  ...
  return (
    ...
    >
      ...
      >
        ...
        <button
          type="button"
          className="bg-none border-none text-muted-foreground w-full p-2 cursor-pointer rounded-lg hover:bg-muted hover:text-foreground transition-colors focus-visible:outline-2 focus-visible:outline-primary focus-visible:outline-offset-2"
          onClick={onClose}
        >
          Cancel
        </button>
