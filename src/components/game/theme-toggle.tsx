...
export function ThemeToggle() {
  ...
  // Listen for theme-toggle events from the command palette
  React.useEffect(() => {
    ...
    window.addEventListener('dealforge:set-theme', handler);
    return () => window.removeEventListener('dealforge:set-theme', handler);
  }, [setTheme, theme]);
