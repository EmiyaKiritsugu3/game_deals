...
export default function AuthModal({ isOpen, onClose }: AuthModalProps) {
  ...
  return (
    <BaseModal isOpen={isOpen} onClose={onClose} ariaLabel="Authentication">
      {/* header: text-align center, mb-8. h2: 2xl extrabold, p: text-sm muted */}
      <div className="text-center mb-8">
        <h2 className="text-2xl font-extrabold mb-2">🚀 Welcome to GameDeals</h2>
        <p className="text-sm text-muted-foreground">
          Sign in to track price drops and sync your wishlist across all devices.
        </p>
      </div>
      {/* socialButtons: flex-col gap-3 my-6 */}
      <div className="flex flex-col gap-3 my-6">
        ...
        <button
          ...
          disabled={isLoading}
        >
          <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor" aria-label="Discord">
            <path d={DISCORD_PATH} />
          </svg>
      ...
      {/* demoNote: mt-6 p-4 bg-primary/[5%] rounded-xl text-xs border border-primary/10 leading-relaxed text-muted-foreground */}
      <div className="mt-6 p-4 bg-primary/[5%] rounded-xl text-xs border border-primary/10 leading-relaxed text-muted-foreground">
