        ...
        <section className="mb-12 rounded-xl bg-white/5 p-6 shadow-md backdrop-blur-md">
            <div className="mb-6 flex flex-col items-center justify-between gap-4 border-b border-white/10 pb-4 md:flex-row">
                <div className="flex flex-wrap items-center justify-center gap-4 md:justify-start">
                    <h2 className="text-xl font-black uppercase tracking-tight text-deal-flash md:text-2xl">⚡ Ofertas Relâmpago</h2>
                    <div className="flex items-center gap-1 rounded bg-deal-flash/20 px-3 py-1 font-mono text-xl font-bold tracking-widest text-deal-flash shadow-[inset_0_0_10px_hsl(var(--deal-flash)/0.2)]">
                ...
                <Link href="/search" className="text-sm font-bold text-muted-foreground transition-colors hover:text-deal-flash">Ver Tudo &gt;</Link>
            </div>
                        ...
                        <Link href={`/game/${deal.gameID}`} key={deal.dealID} className="group relative flex w-[180px] shrink-0 snap-center flex-col overflow-hidden rounded-xl border border-white/10 bg-black/40 transition-all hover:-translate-y-2 hover:border-deal-flash/50 hover:shadow-[0_15px_30px_-5px_hsl(var(--deal-flash)/0.2)] md:w-auto">
                            <div className="relative aspect-[460/215] w-full overflow-hidden bg-black/60">
                                <Image
                                    ...
                                    sizes="180px"
                                />
                                <div className="absolute right-0 top-0 flex items-center justify-center rounded-bl-lg bg-deal-flash px-2 py-1 text-sm font-black text-deal-flash-foreground">-{Math.round(parseFloat(deal.savings))}%</div>
                            </div>

                            <div className="flex flex-1 flex-col justify-between gap-3 p-4">
                                <div className="flex items-baseline gap-1 text-deal-flash">
