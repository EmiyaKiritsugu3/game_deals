...
- Name: visual.spec.ts >> Visual regression >> 4. Game detail page renders correctly
- Location: tests/e2e/visual.spec.ts:29:7
...
Call log:
  - navigating to "http://localhost:3000/game/1", waiting until "load"
