...
- Name: visual.spec.ts >> Visual regression >> 3. Shared wishlist page renders correctly
- Location: tests/e2e/visual.spec.ts:23:7
...
Call log:
  - navigating to "http://localhost:3000/wishlist/shared?ids=", waiting until "load"
